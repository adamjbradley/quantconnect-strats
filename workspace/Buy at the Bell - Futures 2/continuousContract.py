...
class ContinuousFutureRegressionAlgorithm(QCAlgorithm):
    ...
    def OnEndOfAlgorithm(self):
        ...
        if len(self._mappings) != expectedMappingCounts:
            raise ValueError(f"Unexpected symbol changed events: {self._mappings.count()}, was expecting {expectedMappingCounts}")# QUANTCONNECT.COM - Democratizing Finance, Empowering Individuals.
#
