...
class IntradayReversalAlphaModel(AlphaModel):
    ...
    def Update(self, algorithm, data):
        ...
        for kvp in algorithm.ActiveSecurities:
            ...
            # From https://www.quantconnect.com/docs/v2/writing-algorithms/algorithm-framework/alpha/key-concepts#02-Add-Models
            if symbolData.is_uptrend(price, algorithm):
                buyhere = True
                if buyhere:
                    insights.append(Insight.Price(symbol, Resolution.Daily, 20, InsightDirection.UP))
